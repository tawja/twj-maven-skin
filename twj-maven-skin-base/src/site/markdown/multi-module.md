...
Aimed at providing good support for websites of multi-module Maven projects, Tawja Maven Skin has
...
brought together for deployment. Tawja Maven Skin allows reusing resources of top-level module using
...
ensure that URLs are indicated (or derived automatically) correctly for each module. Tawja Maven Skin
