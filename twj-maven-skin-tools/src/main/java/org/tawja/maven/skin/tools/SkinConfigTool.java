 ...
 */
 /**
 * Based on previous work under same licence agreement from :
 *      - Andrius VELYKIS (http://github.com/andriusvelykis/reflow-maven-skin)
 *      - Marek ROMANOWSKI (http://github.com/tunguski/msb3-maven-skin)
 */
package org.tawja.maven.skin.tools;
...
public class SkinConfigTool extends SafeConfig {
	...
	/** By default use Tawja Maven Skin configuration tag */
	public static final String SKIN_KEY = "twjSkin";
