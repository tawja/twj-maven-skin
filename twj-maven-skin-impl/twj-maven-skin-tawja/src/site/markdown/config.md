...
Tawja Maven Skin supports extensive configuration options, including theme, layout, new/updated
...
using the `<custom><twjSkin>` element.
...
-   **[Layouts]( layouts.html )**
    ...
    Tawja the page with different layouts: multi-column text, carousel, thumbnails and others.
...
Tawja Maven Skin has quite a number of configuration options, which can be applied either globally or
